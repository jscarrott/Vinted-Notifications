    ...
    if action == "start":
        if process_name == "telegram":
            ...
            if db.get_parameter("signal_process_running") == "True":
                return jsonify(
                    {"status": "warning", "message": "Signal bot already running"}
                )
            ...
            return jsonify(
                {"status": "success", "message": "Signal bot start requested"}
            )
        ...
        if process_name == "telegram":
            ...
            if db.get_parameter("signal_process_running") != "True":
                return jsonify(
                    {"status": "warning", "message": "Signal bot not running"}
                )
            ...
            return jsonify(
                {"status": "success", "message": "Signal bot stop requested"}
            )
